...
import emp_view_all_book_support
...
def vp_start_gui():
    ...
    emp_view_all_book_support.init(root, top)
    root.mainloop()
...
def create_All_Books_list(root, *args, **kwargs):
    ...
    emp_view_all_book_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class All_Books_list:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.45, rely=0.03, height=47, width=133)
        ...
        self.backButton.configure(command=emp_view_all_book_support.back_Function)

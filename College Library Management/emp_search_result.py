...
import emp_search_result_support
...
def vp_start_gui(a):
    ...
    emp_search_result_support.init(root, top)
    root.mainloop()
...
def create_Search_Result(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = Search_Result (w)
    emp_search_result_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Search_Result:
    def __init__(self, top=None):
        ...
        self.backButton.configure(command=emp_search_result_support.back_Function)

...
import student_view_all_book_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = Tk()
    top = All_Books_list (root)
    student_view_all_book_support.init(root, top)
    root.mainloop()

w = None
def create_All_Books_list(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    top = All_Books_list (w)
    student_view_all_book_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_All_Books_list():
    global w
    w.destroy()
    w = None


class All_Books_list:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.37, rely=0.03, height=47, width=133)
        ...
        self.backButton.configure(command=student_view_all_book_support.back_Function)
        self.backButton.configure(disabledforeground="#a3a3a3")
        self.backButton.configure(font=font9)

...
import emp_search_book_support
...
def vp_start_gui():
    ...
    root = Tk()
    root.resizable(0, 0)
    emp_search_book_support.set_Tk_var()
    top = Search_Book (root)
    emp_search_book_support.init(root, top)
    root.mainloop()
...
def create_Search_Book(root, *args, **kwargs):
    ...
    emp_search_book_support.set_Tk_var()
    top = Search_Book (w)
    emp_search_book_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Search_Book:
    def __init__(self, top=None):
        ...
        self.subject.configure(textvariable=emp_search_book_support.bsub)
        ...
        self.backbutton.configure(command=emp_search_book_support.back_Function)
        ...
        self.searchButton.configure(command=emp_search_book_support.search_Function)
        ...
        self.logoutbutton.configure(command=emp_search_book_support.logout_Function)
